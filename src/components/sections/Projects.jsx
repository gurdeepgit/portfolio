    ...
    return (
        <section id="projects" className="min-h-screen flex items-center justify-center py-20">
            ...
            <div className="max-w-5xl mx-auto px-4">
                <h2 className="font-bold text-3xl mb-8 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent text-center">Featured Projects</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    hover:shadow-[0_2px_8px_rgba(59,120,2246,0.8)] transition">
                        ...
                        <div className="flex justify-between items-center">
                            <a href="" className="text-blue-400 hover:text-blue-400 transition-colors my-4">View Project →</a>
                        </div>
                    </div>
                    <div className="p-6 rounded-xl border border-white/10 hover:-transition-y-1 hover:border-blue-500/30 
                    hover:shadow-[0_2px_8px_rgba(59,120,2246,0.8)] transition">
